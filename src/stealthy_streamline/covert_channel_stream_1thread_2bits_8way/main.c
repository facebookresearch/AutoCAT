...
int main(int argc, char *argv[]) {
  ...
  //gadget_module = dlopen("/home/wenjiex/cache_side_channel/cache-lru-attack-2020-11-16/gadget/liblruattack.so.1.0.1",  RTLD_LAZY);
